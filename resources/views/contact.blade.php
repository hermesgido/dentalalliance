    ...
    <div class="vl-offcanvas">
        <div class="vl-offcanvas-wrapper">
            ...
            <div class="vl-offcanvas-info">
                ...
                <span><a href="#"><i class="fa-solid fa-location-dot"></i>040 Haile Selassie. Dar Es
                        Salaam</a></span>
            </div>
            <div class="space20"></div>
        ...
        <div class="row">
            <div class="col-lg-8 m-auto">
                <div class="heading4 text-center space-margin60">
                    <h5 class="vl-section-subtitle">DA4EA<span> | </span> Advancing Dentistry in East Africa <svg
          ...
          <h2 class="vl-section-title text-anime-style-3">Connect With Our 3 Branch</h2> -->
                </div>
            </div>
        </div>
        <div class="row">
                                ...
                                <div class="icons">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="33" height="32"
                                        ...
                                        <path
                                            ...
                                            stroke="#1C293F" stroke-width="2.2" stroke-linecap="round"
                                ...
                                <div class="icons">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="33" height="32"
                                        ...
                                        <path
                                            ...
                                            stroke="#1C293F" stroke-width="2" stroke-linecap="round"
                                            stroke-linejoin="round" />
                                    </svg>
                                </div>
                                <div class="text">
                                    <h4>Our Email</h4>
                                    <div class="space14"></div>
                                    <a href="mailto: cbenalal@da4ea.com">cbenalal@da4ea.com</a>
                                </div>
                            </div>
                        </div>
                    </div>
