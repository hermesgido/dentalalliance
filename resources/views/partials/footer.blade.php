        ...
        <div class="row">
          <div class="col-lg col-md-6">
            ...
            <div class="footer-widget-area foot-padding1">
              <img src="{{ asset('assets/img/logo/logo1.png')  }}" alt height="80">
              <div class="space30"></div>
              <p>Dental Alliance for East Africa is a social enterprise powered
                by OwosTanzania.
                All profits generated through education are reinvested into
                humanitarian oral-health programs across East Africa.</p>
            </div>
          </div>
          ...
          <div class="col-lg col-md-4">
            ...
            <div class="footer-widget-area">
              <h3>Contact Us</h3>
              <ul>
                <li><a href="tel: +255 741 778 722"><svg
                      ...
                      <path
                        ...
                        stroke="#31353D" stroke-width="1.6"
                        stroke-linecap="round" stroke-linejoin="round" />
                    </svg> +255 741 778 722</a></li>
                <li><a href="#"><svg xmlns="http://www.w3.org/2000/svg"
                      ...
                      <path
                        ...
                        stroke="#31353D" stroke-width="1.6"
                        stroke-linecap="round" stroke-linejoin="round" />
                    </svg> 1040 Haile Selassie. Dar Es Salaam</a></li>
                <li><a href="mailto:cbenalal@da4ea.com"><svg
                      xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                      viewBox="0 0 24 24" fill="none">
                      <path
