...
class StoreProgramModuleRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'slug' => [
                ...
                'string',
                'max:255',
                Rule::unique('program_modules', 'slug')->where(
                    fn ($query) => $query->where('program_id', $this->route('program')->id)
                ),
            ],
            ...
            'delivery_mode' => 'nullable|in:in_person,online',
    ...
    public function normalizedData(): array
    {
        return [
            ...
            'delivery_mode' => $this->string('delivery_mode')->toString() ?: 'in_person',
